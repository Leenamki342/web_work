...
<!-- 
	...
	- 반드시 jquery.js 가 먼저 로딩이 되어있어야지만 동작한다.
...
<style>
	...
	/* 한줄만 text 가 나오고 한줄 넘는 길이는 ... 처리하는 css */
	.card .card-text{
		display : block;
		white-space : nowrap;
...
<div class="container">
	...
	<div class="row">
		...
		<!--
			...
			device 폭 768~992px 에서 칼럼의 폭 => 4/12 (33.333%)
		...
		<div class="col-6 col-md-4 col-lg-3">
			<a href="detail.jsp?num=<%=tmp.getNum()%>">
				<div class="card md-3">
					...
					<div class="card-body">
						<p class="card-title"><%=tmp.getCaption() %></p>
...
<script>
	// card 이미지의 부모요소를 선택해서 imgLiquid 동장(jquery plugin 동작)하기
